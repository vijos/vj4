...
@app.route('/contests', 'contest_main')
...
@app.route('/contests/{tid:\w{24}}/code', 'contest_code')
...
@app.route('/contests/{tid}/{pid:-?\d+|\w{24}}', 'contest_detail_problem')
...
@app.route('/contests/{tid}/{pid}/submit', 'contest_detail_problem_submit')
...
@app.route('/contests/{tid}/status', 'contest_status')
...
@app.route('/contests/create', 'contest_create')
