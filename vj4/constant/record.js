...
export const STATUSES = {
  ...
  STATUS_WRONG_ANSWER: STATUS_WRONG_ANSWER,
  STATUS_TIME_LIMIT_EXCEEDED: STATUS_TIME_LIMIT_EXCEEDED,
  STATUS_MEMORY_LIMIT_EXCEEDED: STATUS_MEMORY_LIMIT_EXCEEDED,
  STATUS_OUTPUT_LIMIT_EXCEEDED: STATUS_OUTPUT_LIMIT_EXCEEDED,
  STATUS_RUNTIME_ERROR: STATUS_RUNTIME_ERROR,
  STATUS_COMPILE_ERROR: STATUS_COMPILE_ERROR,
  STATUS_SYSTEM_ERROR: STATUS_SYSTEM_ERROR,
  STATUS_CANCELED: STATUS_CANCELED,
  STATUS_ETC: STATUS_ETC,
