...
PERM_TEXTS = collections.OrderedDict([
  ...
  (PERM_CREATE_PROBLEM, 'Create problem'),
  (PERM_EDIT_PROBLEM, 'Edit problem'),
  (PERM_EDIT_PROBLEM_SELF, 'Edit their own problem'),
  (PERM_VIEW_PROBLEM, 'View problems'),
  (PERM_SUBMIT_PROBLEM, 'Submit problem'),
  (PERM_READ_PROBLEM_DATA, 'Read data of problem'),
  (PERM_READ_PROBLEM_DATA_SELF, 'Read data of their own problem'),
  (PERM_READ_RECORD_CODE, 'Read record code'),
  (PERM_REJUDGE_PROBLEM, 'Rejudge a problem'),
  (PERM_REJUDGE, 'Rejudge a record'),
  (PERM_VIEW_PROBLEM_SOLUTION, 'View problem solutions'),
  (PERM_CREATE_PROBLEM_SOLUTION, 'Create problem solution'),
  (PERM_VOTE_PROBLEM_SOLUTION, 'Vote a problem solution'),
  (PERM_EDIT_PROBLEM_SOLUTION, 'Edit problem solution'),
  (PERM_EDIT_PROBLEM_SOLUTION_SELF, 'Edit their own problem solution'),
  (PERM_DELETE_PROBLEM_SOLUTION, 'Delete problem solution'),
  (PERM_DELETE_PROBLEM_SOLUTION_SELF, 'Delete their own problem solution'),
  (PERM_REPLY_PROBLEM_SOLUTION, 'Reply a problem solution'),
  (PERM_EDIT_PROBLEM_SOLUTION_REPLY, 'Edit problem solution reply'),
  (PERM_EDIT_PROBLEM_SOLUTION_REPLY_SELF, 'Edit their own problem solution reply'),
  (PERM_DELETE_PROBLEM_SOLUTION_REPLY, 'Delete problem solution reply'),
  (PERM_DELETE_PROBLEM_SOLUTION_REPLY_SELF, 'Delete their own problem solution reply'),
  (PERM_VIEW_DISCUSSION, 'View discussion'),
  (PERM_CREATE_DISCUSSION, 'Create discussion'),
  (PERM_HIGHLIGHT_DISCUSSION, 'Highlight a discussion'),
  (PERM_EDIT_DISCUSSION, 'Edit discussion'),
  (PERM_EDIT_DISCUSSION_SELF, 'Edit their own discussion'),
  (PERM_DELETE_DISCUSSION, 'Delete discussion'),
  (PERM_DELETE_DISCUSSION_SELF, 'Delete their own discussion'),
  (PERM_REPLY_DISCUSSION, 'Reply discussion'),
  (PERM_EDIT_DISCUSSION_REPLY, 'Edit discussion reply'),
  (PERM_EDIT_DISCUSSION_REPLY_SELF, 'Edit their own discussion reply'),
  (PERM_EDIT_DISCUSSION_REPLY_SELF_DISCUSSION, 'Edit discussion reply of their own discussion'),
  (PERM_DELETE_DISCUSSION_REPLY, 'Delete discussion reply'),
  (PERM_DELETE_DISCUSSION_REPLY_SELF, 'Delete their own discussion reply'),
  (PERM_DELETE_DISCUSSION_REPLY_SELF_DISCUSSION, 'Delete discussion reply of their own discussion'),
  (PERM_VIEW_CONTEST, 'View contest'),
  (PERM_VIEW_CONTEST_STATUS, 'View contest status'),
  (PERM_VIEW_CONTEST_HIDDEN_STATUS, 'View hidden contest status'),
  (PERM_CREATE_CONTEST, 'Create contest'),
  (PERM_ATTEND_CONTEST, 'Attend a contest'),
