...
PERM_SET_PERM = 1
PERM_VIEW_PROBLEM = 2
PERM_SUBMIT_PROBLEM = 4
PERM_VIEW_PROBLEM_SOLUTION = 8
PERM_SUBMIT_PROBLEM_SOLUTION = 8
PERM_VOTE_PROBLEM_SOLUTION = 16
PERM_REPLY_PROBLEM_SOLUTION = 32
PERM_VIEW_DISCUSSION = 64
PERM_CREATE_DISCUSSION = 128
PERM_REPLY_DISCUSSION = 256
PERM_TAIL_REPLY_DISCUSSION = 512
PERM_READ_PROBLEM_DATA = 1024
PERM_VIEW_CONTEST = 2048
PERM_VIEW_CONTEST_STATUS = 4096
PERM_CREATE_CONTEST = 8192
PERM_VIEW_TRAINING = 16384
PERM_ALL = -1
...
# Footer extra HTMLs.
FOOTER_EXTRA_HTMLS = ['© 2005 - 2016 Vijos.org', '{$GIT_REVISION}', 
