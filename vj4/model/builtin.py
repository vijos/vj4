...
PERM_HIGHLIGHT_DISCUSSION = 1 << 21
PERM_EDIT_DISCUSSION = 1 << 22
PERM_DELETE_DISCUSSION = 1 << 23
PERM_REPLY_DISCUSSION = 1 << 24
PERM_EDIT_DISCUSSION_REPLY = 1 << 25
PERM_DELETE_DISCUSSION_REPLY = 1 << 26

# Contest.
PERM_VIEW_CONTEST = 1 << 27
PERM_VIEW_CONTEST_STATUS = 1 << 28
PERM_VIEW_CONTEST_HIDDEN_STATUS = 1 << 29
PERM_CREATE_CONTEST = 1 << 30
PERM_ATTEND_CONTEST = 1 << 31

# Training.
PERM_VIEW_TRAINING = 1 << 32
