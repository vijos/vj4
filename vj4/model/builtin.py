...
PERM_REJUDGE_PROBLEM = 1 << 10
PERM_REJUDGE = 1 << 11

# Problem Solution.
PERM_VIEW_PROBLEM_SOLUTION = 1 << 12
PERM_CREATE_PROBLEM_SOLUTION = 1 << 13
PERM_VOTE_PROBLEM_SOLUTION = 1 << 14
PERM_EDIT_PROBLEM_SOLUTION = 1 << 15
PERM_EDIT_PROBLEM_SOLUTION_SELF = 1 << 16
PERM_DELETE_PROBLEM_SOLUTION = 1 << 17
PERM_DELETE_PROBLEM_SOLUTION_SELF = 1 << 18
PERM_REPLY_PROBLEM_SOLUTION = 1 << 19
PERM_EDIT_PROBLEM_SOLUTION_REPLY = 1 << 20
PERM_EDIT_PROBLEM_SOLUTION_REPLY_SELF = 1 << 21
PERM_DELETE_PROBLEM_SOLUTION_REPLY = 1 << 22
PERM_DELETE_PROBLEM_SOLUTION_REPLY_SELF = 1 << 23

# Discussion.
PERM_VIEW_DISCUSSION = 1 << 24
PERM_CREATE_DISCUSSION = 1 << 25
PERM_HIGHLIGHT_DISCUSSION = 1 << 26
PERM_EDIT_DISCUSSION = 1 << 27
PERM_EDIT_DISCUSSION_SELF = 1 << 28
PERM_DELETE_DISCUSSION = 1 << 29
PERM_DELETE_DISCUSSION_SELF = 1 << 30
PERM_REPLY_DISCUSSION = 1 << 31
PERM_EDIT_DISCUSSION_REPLY = 1 << 32
PERM_EDIT_DISCUSSION_REPLY_SELF = 1 << 33
PERM_EDIT_DISCUSSION_REPLY_SELF_DISCUSSION = 1 << 34
PERM_DELETE_DISCUSSION_REPLY = 1 << 35
PERM_DELETE_DISCUSSION_REPLY_SELF = 1 << 36
PERM_DELETE_DISCUSSION_REPLY_SELF_DISCUSSION = 1 << 37

# Contest.
PERM_VIEW_CONTEST = 1 << 38
PERM_VIEW_CONTEST_STATUS = 1 << 39
PERM_VIEW_CONTEST_HIDDEN_STATUS = 1 << 40
PERM_CREATE_CONTEST = 1 << 41
PERM_ATTEND_CONTEST = 1 << 42

# Training.
PERM_VIEW_TRAINING = 1 << 43
